...
function renderDealResult(data) {
  ...
  result.innerHTML = `
    ...
    <div class="deal-result-ctas">
      <a href="#" class="btn-primary">Get the full universe + book a pilot &rarr;</a>
      <button class="btn-secondary" onclick="alert('Summary download coming soon')">Download this summary</button>
    </div>
  `;
